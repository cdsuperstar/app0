  ...
  <q-page padding class="q-pa-ma">
    ...
    <div class="shadow-1">
      <ag-grid-vue
        ...
        class="ag-theme-balham p2sonqd-agGrid"
  ...
  methods: {
    initGrid() {
      ...
      this.columnDefs = [
        ...
        {
          headerName: this.$t('p2s1.province'),
          field: 'name',
          width: 110,
          minWidth: 110,
          maxWidth: 170,
        ...
        {
          headerName: this.$t('p2s1.country'),
          field: 'title',
          width: 120,
          minWidth: 120,
          maxWidth: 180,
...
.p2sonqd-agGrid .ag-header {
  background-color: var(--q-color-secondary);
  color: #ffffff;
}
.p2sonqd-agGrid .ag-cell {
  padding-left: 1px;
}
