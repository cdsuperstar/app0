  ...
  <q-page class="q-pa-xs">
    ...
    <div class="q-mx-ma">
      <dl>
        ...
        <dd
          v-if="vote.b1 === '是' && (vote.b5 === '一般' || vote.b5 === '较差')"
          :class="$q.screen.gt.xs ? 'row q-mx-ma' : 'q-mx-sm'"
        >
          <div style="padding-top: 10px;">
        ...
        >
          <div style="padding-top: 10px;">
            C11. 您认为培训对您家就业没有帮助的原因是什么？（多选）【可输入】
          </div>
          <q-select
            v-model="vote.c11"
            dense
        ...
        >
          <div style="padding-top: 10px;">
            E10. 家里是否有在读高校学生（专科、本科、研究生及以上）？（单选）
          </div>
          <q-select
            v-model="vote.e10"
            dense
        ...
        <dd :class="$q.screen.gt.xs ? 'row q-mx-ma' : 'q-mx-sm'">
          <div style="padding-top: 10px;">
            E19. 您希望县、乡/镇医院在以下哪些方面做出改进？（多选）【可输入】
          </div>
          <q-select
            v-model="vote.e19"
            dense
        ...
        <dd :class="$q.screen.gt.xs ? 'row q-mx-ma' : 'q-mx-sm'">
          ...
          <q-select
            ...
            style="min-width: 22em;"
            behavior="menu"
            :options="['路灯', '垃圾池或者垃圾桶', '公共警务室', '公共厕所']"
          ></q-select>
        </dd>
        <dd :class="$q.screen.gt.xs ? 'row q-mx-ma' : 'q-mx-sm'">
          <div style="padding-top: 10px;">
